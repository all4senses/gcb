 ...
 * 3. Read carefully, especially within gcb_preprocess_html(), there
...
function gcb_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
//  $media_queries_css = array(
//    'gcb_orange.responsive.style.css',
//    'gcb_orange.responsive.gpanels.css'
//  );
//  load_subtheme_media_queries($media_queries_css, 'gcb_orange');
...
//  );
//  load_subtheme_ie_styles($ie_files, 'gcb_orange');
...
function gcb_process_html(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gcb_preprocess_page(&$vars) {
}

function gcb_process_page(&$vars) {
}
// */
...
function gcb_preprocess_node(&$vars) {
}

function gcb_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function gcb_preprocess_comment(&$vars) {
}

function gcb_process_comment(&$vars) {
}
// */
 ...
 */
function gcb_preprocess_block(&$vars) {
...
function gcb_process_block(&$vars) {
}
// */
